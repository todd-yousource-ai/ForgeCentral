...
/** The binding prefixes whose chapters have been verified (GD.3 Settings; GD.4 VTZ; GD.5 Objects; GD.6 Policies; GD.7 Users + IdAM; GD.8 SOC). */
const SCOPE = ['settings.', 'soc.', 'vtz.', 'objects.', 'policies.', 'users.', 'groups.', 'idam.'];
