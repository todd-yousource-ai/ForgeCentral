...
const unusedClient: CrucibleClient = {
  ...
  socPlanApprove: () => Promise.reject(new Error('unused')),
  socPlanModify: () => Promise.reject(new Error('unused')),
  socIncidentDetail: () => Promise.reject(new Error('unused')),
  socNarrative: () => Promise.reject(new Error('unused')),
  socTelemetry: () => Promise.reject(new Error('unused')),
  socAudit: () => Promise.reject(new Error('unused')),
  socImpact: () => Promise.reject(new Error('unused')),
  ...
  settingsCommit: () => Promise.reject(new Error('unused')),
  settingsReports: () => Promise.reject(new Error('unused')),
  settingsPropose: () => Promise.reject(new Error('unused')),
  settingsApprovals: () => Promise.reject(new Error('unused')),
  settingsApprove: () => Promise.reject(new Error('unused')),
  settingsHistory: () => Promise.reject(new Error('unused')),
  settingsRollback: () => Promise.reject(new Error('unused')),
  ...
  socNotes: () => Promise.reject(new Error('unused')),
  socDisposition: () => Promise.reject(new Error('unused')),
