...
Status: **PLAN AUTHORED (2026-07-10), pending review.** No code landed yet. Supersedes the Node/OpenSSL
...
|------|-----------|--------|--------|-------|
| CS.1 | INV-SIDECAR-BIND-FAILCLOSED | OPEN | -- | Standalone `sidecar/` Rust crate + CI leg; `SidecarConfig` + node-IP bind guard, fail-closed; unit tests. |
