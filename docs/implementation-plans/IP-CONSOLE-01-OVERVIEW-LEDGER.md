...
| O1.6 | INV-CONSOLE-3-CLICKS | **PARTIAL** | O1.6a landed (this PR) | Interaction + click-through to the drawer + the two canonical <=3-click tasks. PR-1 (O1.6a data path) LANDED; PR-2 (O1.6b interaction) OPEN. See PR plan below. |
