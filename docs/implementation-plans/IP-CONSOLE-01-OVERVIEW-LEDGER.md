...
Status: **IN PROGRESS -- the surface renders live AND is interactive + E2E-capstoned (O1.6 <=3-click LANDED through PR-2c-2); still OPEN: O1.7 live deltas (PR-3) + overflow honesty (PR-4).**
